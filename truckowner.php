...
<div id="contentwrapper">
  <div class="main_content">
    ...
    <div class="row-fluid">
      <div class="span12">
        <h3 class="heading">TruckOwner List</h3>
        <table class="table table-bordered table-striped table_vam" id="index">
          ...
          <tbody>
            <?php 
			$truckowner_list = $truckowner->listAllTruckOwner();
		//	mypr($truckowner_list);
			$sr = 1;
			foreach($truckowner_list as $one){
            ...
            <tr>
              ...
              <td class="actions ">
                ...
                <a href="truckowner.delete.php?id=<?php echo $one['id'];?>" onclick="if (confirm(&quot;Are you sure you want to delete Truck # <?php echo $one['truck_number'];?> ?&quot;)) { document.post_5780779d45e6f682073240.submit(); } event.returnValue = false; return false;">Delete</a>		
               <a href="truckowner.view.php?id=<?php echo $one['id'];?>">View/Edit</a></td>
            </tr>
            <?php
				$sr ++;
				}
