...
//			$_POST['data']['party']['id'] = $_GET['id'];
			$inserted_id = $party->insert($_POST['data']['party']);
//		echo $inserted_id;
	...
	<div class="formSep guj">
		<div class="row-fluid">
			<div class="span4">
				...
				<input  name="data[party][name]" value="" class="span12 guj" maxlength="255" type="text" >				
			</div>
            <div class="span4">
            ...
            <div class="span4">
				...
				<input  name="data[party][address]" class="span12 guj" value="" maxlength="255" type="text" id="TruckEngineNo">			
            </div>
		</div>
	</div>
	...
	<div class="formSep">
    	<div class="row-fluid">
			<div class="span4">
				...
				<input name="data[party][m1]" class="span12 guj" maxlength="255" type="text" value="">				
			</div>
            <div class="span4">
				<label  class="guj">maao.2 <span class="f_req">*</span></label>
				<input  name="data[party][m2]" value="" class="span12 guj" maxlength="255" type="text" id="TruckChassisNo">			
            </div>
            <div class="span4">
				<label  class="guj">maao.3<span class="f_req">*</span></label>
				<input  name="data[party][m3]" class="span12 guj" value="" maxlength="255" type="text" id="TruckEngineNo">			
            </div>
		</div>
    ...
    <div class="formSep">
    	<div class="row-fluid">
			<div class="span4">
				...
				<input  name="data[party][mail]" class="span12" maxlength="255" type="text" value="">				
			</div>
            <div class="span4">
...
<script type="text/javascript">
  ...
  gebo_validation = {
	...
	//				'data[Order][client_id]': { required: true },
					'data[party][name]': { required: true },
					'data[party][gaam]': { required: true },
					'data[party][address]': { required: true },
					'data[party][m1]': { required: true },
					'data[party][mail]': { required: true },
