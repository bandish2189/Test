...
//	exit;
	?>
      <h3 class="heading">Bill No:
       <input name="data[Order][t_no]" readonly maxlength="50" type="text"  value="<?php echo $order_details['t_no']; ?>" id="OrderLrNo"/>        
       Date : 
<!--        <input name="data[Order][order_generation_date]" id="dp1" value="" type="text"/> -->

        <input type="text"  id="mask_date" name="data[Order][order_generation_date]" value="<?php $date=date_create($order_details['date']); echo date_format($date,"d/m/Y");?>" />
        <b class="guj">maalanauM naama : </b>
        <select name="data[Order][pro_id]" class="guj" >
        <option></option>
        <?php if(isset($products)){
			mypr($products);
			foreach($products as $pro){
					if($order_details['pro_id'] == $pro['id']){
						echo '<option class="guj" selected value="'.$pro['id'].'">'.$pro['name'].'</option>';
					}else{
						echo '<option class="guj" value="'.$pro['id'].'">'.$pro['name'].'</option>';
						}
				}
  ...
  <div class="span3">
          ...
          <div id="txtHint">
          <input type="hidden" name="data[Order][seller_id]" id="sellerId" value=""/> 
           <input name="data[Order][seller_name]" class="span10 guj" type="text" value="<?php echo $order_details['seller_name'];?>" id="clientsName"/> 
          	           </div>
        ...
        <div class="span3">
          ...
          <select name="data[Order][seller_city]" class="span10 guj" id="OrderOrderCity" onchange="javascript:ajax_gaam(this,&quot;sell&quot;)" >
          
<option value="">saIlaokT krao </option>
        <?php  

	foreach($city_list as $city_one){
			if($city_one['CityName']==$order_details['seller_gaam']){
				echo '<option selected value="'.$city_one['CityId'].'">'.$city_one['CityName'].'</option>';
			}else{
				echo '<option value="'.$city_one['CityId'].'">'.$city_one['CityName'].'</option>';
				}
	} //End-Foreach
?>
...
<div class="row-fluid ">
  <div class="span3">
          ...
          <input type="hidden" name="data[Order][buyer_id]" id="buyerId"/> 
           <input name="data[Order][buyer_name]" class="span10 guj" type="text" id="buyerName" value="<?php echo $order_details['buyer_name'];?>"/> 
          	           </div>
...
<option value="">saIlaokT krao </option>
		...
		foreach($city_list as $city_one){
				if($city_one['CityName']==$order_details['buyer_gaam']){
					echo '<option selected value="'.$city_one['CityId'].'">'.$city_one['CityName'].'</option>';
				}else{
					echo '<option value="'.$city_one['CityId'].'">'.$city_one['CityName'].'</option>';
					}
      ...
      <div class="row-fluid ">
        ...
        <input class="span12" name="data[Order][guni]" value="<?php echo $order_details['guni'];?>">
        </div>
        <div class="span4">
        <label class="guj">Baava<span class="f_req">*</span></label>
        <input class="span12" name="data[Order][price]" value="<?php echo $order_details['price'];?>">
        </div>
        <div class="span4">
        <label class="guj">BartaI<span class="f_req">*</span></label>
        <input class="span12" name="data[Order][bharti]" value="<?php echo $order_details['bharti'];?>">
        </div>
      </div>
      <div class="row-fluid ">
      	<div class="span12">
        <label class="guj">naaoMV<span class="f_req">*</span></label>
        <textarea class="span12 guj" name="data[Order][note]"><?php echo $order_details['note'];?></textarea>
        </div>
      </div>
      <div class="row-fluid ">
      	<div class="span10">
       	...
       	<div class="span2">
        <input type="submit" value="sauQaarao" class="guj btn btn-primary">
        </div>


      </div>
    </div>
    </div>  <!--   row fluid complate -->
