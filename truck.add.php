...
//	exit;
	if(isset($_POST['data']['Truck'])&& (strlen($_POST['data']['Truck']['truck_number'])> 0) ){
		$inserted_id = $truck->createTruck($_POST['data']['Truck']);
//		echo $inserted_id;
...
<form action="" class="form_validation_reg" id="TruckAddForm" method="post" accept-charset="utf-8" novalidate="novalidate"><div style="display:none;"><input type="hidden" name="_method" value="POST"></div>

	<div class="formSep">
		<div class="row-fluid">
			<div class="span4">
				<label>Truck Number <span class="f_req">*</span></label>
				<input name="data[Truck][truck_number]" class="span12" maxlength="255" type="text" id="TruckTruckNumber">				<span class="help-block">Note: Truck number should be unique</span>
			</div>
		</div>
	</div>
	...
	<div class="formSep">
		<div class="row-fluid">
			<div class="span4">
				...
				<input name="data[Truck][chassis_no]" empty="--- Select Truck Owner City ---" class="span12" maxlength="255" type="text" id="TruckChassisNo">			</div>
		</div>
	</div>
	...
	<div class="formSep">
		<div class="row-fluid">
			<div class="span4">
				...
				<input name="data[Truck][engine_no]" class="span12" maxlength="255" type="text" id="TruckEngineNo">			</div>
		</div>
	</div>
	...
	<div class="formSep">
		<div class="row-fluid">
			<div class="span4">
				<label>Note</label>
				<textarea name="data[Truck][note]" class="span12" rows="4" cols="8" id="TruckNote"></textarea>			</div>
		</div>
	</div>
...
<option value="1">Owner 1 - 0123456789</option>
<option value="2">OWNER2 - 9426535218</option>
<option value="3">OWNER - 1023456789</option>
<option value="4"> - </option>
<option value="5"> - </option>
<option value="6"> - 7383792302</option>
<option value="7"> - 9924872431</option>
<option value="8"> - 9426998253</option>
<option value="9">OWNER2 - 9426535218</option>
<option value="10"> - 9825386353</option>
<option value="11"> - 9426643820</option>
<option value="12"> - 8401966545</option>
<option value="13"> - 9979402800</option>
<option value="14"> - </option>
<option value="15"> - </option>
<option value="16"> - 9426918291</option>
<option value="17"> - 9723246930</option>
<option value="18"> - 9426599120</option>
<option value="19"> - </option>
<option value="20">OWNER - 9824763423</option>
<option value="21"> - </option>
<option value="22">Rajeshbhai - 9913176251</option>
<option value="23">-- - --</option>
<option value="24">BANDISH - 9913176251</option>
<option value="25">BANDISH - 9913176251</option>
</select>			</div>
		</div>
	</div>
	...
	<div class="formSep">
		<div class="row-fluid">
			<div class="span4">
				<label>RC Book</label>
				<textarea name="data[Truck][rcbook]" class="span12" rows="4" cols="8" id="TruckRcbook"></textarea>			</div>
		</div>
	</div>
	...
	<div class="formSep">
		<div class="row-fluid">
			<div class="span4">
				...
				<textarea name="data[Truck][insurance]" class="span12" rows="4" cols="8" id="TruckInsurance"></textarea>			</div>
		</div>
	</div>
	...
	<div class="formSep">
		<div class="row-fluid">
			<div class="span4">
				<label>Address</label>
				<textarea name="data[Truck][permit]" class="span12" rows="4" cols="8" id="TruckPermit"></textarea>			</div>
		</div>
	</div>
