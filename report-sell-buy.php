...
//	exit;
	?>
      <h3 class="heading"><b class="guj">paaTI-naao KarId vaocaaNa  </b>(<strong style="color:#3E78FF;"><?php echo $_SESSION['userCakeUser']->company['name']; ?></strong>) <a target="_blank" href="report-sell-buy-allparty.php" class="guj">baQaI paaTI- naao</a></h3>
              <div class="row-fluid">
            <div class="span12 well">
            	 <div class="span3">
                  <label class="guj">vaocanaarnau naama<span class="f_req">*</span></label>
                      <div id="txtHint">
                          <input type="hidden" name="data[party_id]" id="sellerId"/> 
                          <input name="data[party]" class="span10 guj" type="text" id="clientsName"/> 
                      </div>
	              </div>
	        <div class="span2">
              <label class="guj">gaama<span class="f_req">*</span></label>
              <select name="data[gam]" class="span10 guj" id="OrderOrderCity" onchange="javascript:ajax_party(this,&quot;sell&quot;)" >
					<option value="">saIlaokT krao </option>
						<?php  echo $city_list_htm ; ?>
				</select>	
        	</div>
            <div class="span2">
              <label >From<span class="f_req">*</span></label>
              <input name="data[from]" id="dp1" value="" type="text" class="span10"/>        
        	</div>
            <div class="span2">
              <label >To<span class="f_req">*</span></label>
              <input name="data[to]" id="dp2" value="" type="text" class="span10"/>        
        	</div>
       
            <div class="span2">
            <input type="submit" class="btn btn-gebo guj" value="jaovaao">  
        	</div>
  ...
  <style type="text/css"> 
  .party_heading { font-size:+43px; width:100%; text-align:center; line-height:40px; color:#000;}
  ...
  <style tyle="text/css">
   ...
   .party_heading { font-size:+43px;}
   #dt_order > thead > tr > th:nth-child(2){ width:600px;}
...
<i class="splashy-printer" onclick="window.print();" style="float:right; cursor:pointer;"></i>
            <h4 class="alert-heading party_heading"><?php echo $party_details['PartyName']; ?></h4>
           <ul>
...
<table class="table table-bordered table-striped">
	...
	if($_POST['data']['party_id'] == $one['seller']){
