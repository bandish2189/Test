...
<div id="contentwrapper">
  <div class="main_content">
    ...
    <div class="row-fluid">
      <div class="span12">
        <h3 class="heading">Client List</h3>
...
///			mypr($party_list);
            ...
            <tr>
              ...
              <td><?php echo $one['contact_person'];?></td>
              
              <td><?php echo $one['contact_no'];?></td>
              <td><?php echo $one['email_address'];?>&nbsp;</td>
              <td><?php echo $one['created'];?></td>
              <td class="actions"><a href="party.view.php?id=<?php echo $one['id'];?>">View/Edit</a></td>
            </tr>
            <?php
				$sr ++;
				}
