...
if(isset($_POST['data'])){
	echo 'post';
//	mypr($_POST['data']['party']);
//	echo strlen($_POST['data']['clients']['id']);
//	exit;

	if(isset($_POST['data']['party'])){
		if(!empty($_GET['id'])){
			$_POST['data']['party']['id'] = $_GET['id'];
			$inserted_id = $party->updateParty($_POST['data']['party']);
		}
//		echo $inserted_id;
...
//		$_POST['data']['clients']['date']= date_format($date,"Y-m-d");
	if(!empty($_GET['id'])){
		...
		$party_details = $party->getParty($_GET['id']);
		mypr($party_details);
	//	header('Location: parties.php');
	//exit;	
		
	}else{
		header('Location: truckowner.php');
		}
...
<form action="" class="form_validation_reg" id="TruckAddForm" method="post" accept-charset="utf-8" novalidate><div style="display:none;"><input type="hidden" name="_method" value="POST"></div>
	...
	<div class="formSep guj">
		<div class="row-fluid">
			<div class="span4">
				<label class="guj">paaTI-nauM naama.<span class="f_req">*</span></label>
				<input  name="data[party][name]" value="<?php echo $party_details['PartyName']; ?>" class="span12 guj" maxlength="255" type="text" >				
			</div>
            <div class="span4">
				<label  class="guj">gaama <span class="f_req">*</span></label>
				<select name="data[party][gaam]" class="guj">
											<?php
                                            
                                            foreach($city_list as $ci){
												if($ci['CityId'] == $party_details['city']){
													echo "<option selected value='".$ci['CityId']."'>".$ci['CityName']."</option>";
												}else{
            ...
            <div class="span4">
				<label class="guj">sarnaamau<span class="f_req">*</span></label>
				<input  name="data[party][address]" class="span12 guj" value="<?php echo $party_details['address']; ?>" maxlength="255" type="text" id="TruckEngineNo">			
            </div>
		</div>
	</div>
	...
	<div class="formSep">
    	<div class="row-fluid">
			<div class="span4">
				<label class="guj">maao.1 <span class="f_req">*</span></label>
				<input name="data[party][m1]" class="span12 guj" maxlength="255" type="text" value="<?php echo $party_details['m1']; ?>">				
			</div>
            <div class="span4">
				<label  class="guj">maao.2 <span class="f_req">*</span></label>
				<input  name="data[party][m2]" value="<?php echo $party_details['m2']; ?>" class="span12 guj" maxlength="255" type="text" id="TruckChassisNo">			
            </div>
            <div class="span4">
				<label  class="guj">maao.3<span class="f_req">*</span></label>
				<input  name="data[party][m3]" class="span12 guj" value="<?php echo $party_details['m3']; ?>" maxlength="255" type="text" id="TruckEngineNo">			
            </div>
		</div>
    ...
    <div class="formSep">
    	<div class="row-fluid">
			<div class="span4">
				<label class="guj" >[mao[la <span class="f_req">*</span></label>
				<input  name="data[party][mail]" class="span12" maxlength="255" type="text" value="<?php echo $party_details['mail']; ?>">				
			</div>
            <div class="span4">
            <label class="guj">&nbsp;<span class="f_req"></span></label>
				<button class="btn btn-inverse" type="submit">Save changes</button>
		<a href="/trucks" class="btn">Cancel</a>	
            </div>
