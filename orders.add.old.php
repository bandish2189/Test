...
require_once("models/header_old.php");
include("top-nav-old.php");
$city = new City();
...
<form action="orders.add.php" method="post" id="defaultForm" class="form_validation_ttip" accept-charset="utf-8">
...
<div class="antiScroll">
	<div class="antiscroll-inner">
		<div class="antiscroll-content">
            ...
            <script type="text/javascript" src="../trans/js/jquery.debouncedresize.min.js"></script>
			<script type="text/javascript" src="../trans/js/jquery.actual.min.js"></script>
			<script type="text/javascript" src="../trans/js/jquery.cookie.min.js"></script>
			<script type="text/javascript" src="../trans/js/bootstrap/js/bootstrap.min.js"></script>
			<script type="text/javascript" src="../trans/js/lib/qtip2/jquery.qtip.min.js"></script>
            <script type="text/javascript" src="../trans/js/lib/qtip2/jquery.qtip.min.js"></script>
            <script type="text/javascript" src="../trans/js/lib/jBreadcrumbs/js/jquery.jBreadCrumb.1.1.min.js"></script>
			<script type="text/javascript" src="../trans/js/lib/sticky/sticky.min.js"></script>
			<script type="text/javascript" src="../trans/js/ios-orientationchange-fix.js"></script>
			<script type="text/javascript" src="../trans/js/lib/antiscroll/antiscroll.js"></script>
			<script type="text/javascript" src="../trans/js/lib/antiscroll/jquery-mousewheel.js"></script>
			<script type="text/javascript" src="../trans/js/lib/colorbox/jquery.colorbox.min.js"></script>
			<script type="text/javascript" src="../trans/js/gebo_common.js"></script>    
            <script type="text/javascript" src="../trans/js/lib/smoke/smoke.js"></script>
            <script src="../trans/js/gebo_notifications.js"></script>
