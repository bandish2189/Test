...
echo date_format($date,"d–m–Y");
			  //echo date("d/m/Y",$one['date']);?>&nbsp;</td>
              <td><a href="orders.edit.php?order=<?php echo $one['id'];?>" class="btn btn-warning" style="font-size:19px" >sauQaarao</a><a href="invoice.php?order=<?php echo $one['id'];?>" class="btn btn-success" style="font-size:19px" target="new" >baIla</a></td>
