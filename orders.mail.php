...
<script type="text/javascript">
	var counter = 0;
  function ajax_mail(obj,action,date){
//	  alert('ajax party');
...
#dt_order_filter > label > input[type="text"]{
	...
	//		//	$order->updateTransaction($one);
            ...
            <tr class="guj" id="row<?php echo $one['id']; ?>">
              ...
              <td><a href="party.edit.php?id=<?php echo $one['seller'];?>"><?php echo $one['seller_name'];?></a>&nbsp;</td>
              <td><?php echo $one['seller_gaam'];?>&nbsp;</td>
              <td><a href="party.edit.php?id=<?php echo $one['buyer'];?>"><?php echo $one['buyer_name'];?>&nbsp;</td>
              <td><?php echo $one['buyer_gaam'];?>&nbsp;</td>
              <td><button class="btn btn-success" onClick="javascript:ajax_mail(this,'<?php echo $one['id']; ?>','<?php echo $this_date; ?>');" style="font-size:19px" >Mail</button>
			  &nbsp;</td>
