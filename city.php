...
<div id="contentwrapper">
  <div class="main_content">
    <nav>
      <div id="jCrumbs" class="breadCrumb module">
        <ul>
          ...
          <li> <a href="" class="guj"> gaama </a> </li>
          <li>Index</li>
        </ul>
      </div>
    </nav>
    ...
    <div class="row-fluid">
      <div class="span12">
        <h3 class="heading guj" >gaamanauM laIsT <a class="btn btn-success guj" href="city.add.php">]maorao</a></h3>
         <table class="table table-bordered table-striped table_vam" id="index">
          <thead>
            <tr class="guj">
               <th>gaamanauM naama</th>
                <th></th>
            </tr>
          </thead>
          <tbody>
...
//			exit;
			$sr = 1;
			foreach($city_list as $one){
				
//				mypr($one);
			?>
            <tr class="guj">
              <td><?php echo $one['CityName'];?></td>
              
              <td class="actions"><a class="btn btn-danger" style="font-family:Cambria, 'Hoefler Text', 'Liberation Serif', Times, 'Times New Roman', serif !important;" href="city.delete.php?id=<?php echo $one['CityId'];?>" onclick="if (confirm(&quot;Are you sure you want to delete Truck # <?php echo $one['truck_number'];?> ?&quot;)) { document.post_5780779d45e6f682073240.submit(); } event.returnValue = false; return false;">Delete</a>		</td>
            </tr>
            <?php
	//		exit;
				$sr ++;
